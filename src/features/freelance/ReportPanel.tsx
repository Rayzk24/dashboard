...
const pdfStyles = StyleSheet.create({
  ...
  markLetter: { fontFamily: 'Helvetica-Bold', fontSize: 17, letterSpacing: -0.7 },
  markDot: { fontFamily: 'Helvetica-Bold', fontSize: 17, color: accent },
  brandName: { fontFamily: 'Helvetica-Bold', fontSize: 10.5 },
